 ...
 * 2017-07-13T22:08:08.482-04:00
 * Generated source version: 2.7.8
 * 
 */
@WebServiceClient(name = "Orders", 
                  wsdlLocation = "file:/Users/jingshanyin/apache-cxf-jax-ws-demo/src/main/resources/wsdl/Orders.wsdl",
...
public class Orders_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/jingshanyin/apache-cxf-jax-ws-demo/src/main/resources/wsdl/Orders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Orders_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/jingshanyin/apache-cxf-jax-ws-demo/src/main/resources/wsdl/Orders.wsdl");
        }
        WSDL_LOCATION = url;
    }
